                    ...
                    for (let i = 0; i < arrdata.length; i++) {
                        ...
                        <li class="li_8">
                            ...
                            $('.li_6_1').on('click', function () {
                                ...
                                var index = $('.li_6_1').index($(this));
                                var num = $(".li_6_3").eq(index).val();
                                num--;
                                console.log(num)
                                $(".li_6_3").eq(index).val(num);

                             $(this).parentsUntil('.cart_').parent().find('.totalprice').html(($('.li_5').html()) * ($(".li_6_3").eq(index).val()))
